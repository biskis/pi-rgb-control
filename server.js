...
var RgbStripApp = function() {
    ...
    self.start = function() {
        ...
        self.app.listen(config.get('server.port'), function() {
            ...
            console.log('API URL:', config.get('server.api_base_url'), config.get('server.port'));
        });
    };
};
 ...
 *  main():  Main code.
 */
var rgbStripApp = new RgbStripApp();
rgbStripApp.initialize();
rgbStripApp.start();
